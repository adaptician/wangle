...
{
    public abstract class WangleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WangleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WangleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WangleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WangleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WangleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WangleDbContext, Task<T>> func)
        {
            T result;
